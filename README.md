# Documentary-of-Bug-Bounty-Reports
This repository contains a collection of security vulnerability reports discovered through my participation in various bug bounty programs for an assignment in a module of my degree program. Each report includes a detailed explanation of the issue, steps to reproduce, proof of concept (PoC), impact analysis, and recommended remediations. A video explonation is also attached based on my insight.
